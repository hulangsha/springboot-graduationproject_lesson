package com.sicau.springbootgraduationproject.generator;
...
//        gc.setOutputDir(projectPath);
        ...
        dsc.setUrl(
                "jdbc:mysql://127.0.0.1:3306/lessonplanmanagementsystem?useUnicode=true&characterEncoding=utf8");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("facade");// 模块名
//        pc.setParent("");
        ...
        strategy.setInclude("t_friendship_links");// 表名
